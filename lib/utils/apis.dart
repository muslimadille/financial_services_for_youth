class Apis{
  ...
  static String BASE_URL="https://services.topbits-tech.com/api/v1";
  static String CATEGORIES_API="${BASE_URL}/categories";
  static String PROVIDER_API="${BASE_URL}/providers";
  static String STATIC_PAGES_API="${BASE_URL}/static-pages";
